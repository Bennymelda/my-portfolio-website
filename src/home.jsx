...
md:flex-row-reverse items-center md:justify-center' >
    <div className='flex items-center gap-2 md:mb-5 flex-col sm:flex md:hidden'> 
        ...
        <span className='text-orange-600 font-cursive'>𝓘𝓫𝓮𝓼𝓲 𝓑𝓮𝓷𝓮𝓭𝓲𝓬𝓽𝓪</span>
    </div>
    ...
    <div className=' items-start gap-2 hidden flex-col sm:hidden md:flex'> 
        <h2 className='text-white font-bold text-2xl'>Hello, my name is</h2>
        <span className='text-orange-600 '>𝓘𝓫𝓮𝓼𝓲 𝓑𝓮𝓷𝓮𝓭𝓲𝓬𝓽𝓪</span>
    </div>
    <div>
     <p className='text-xl   font-bold '>i'm a <span className='text-xl text-orange-600'>
      𝓕𝓻𝓸𝓷𝓽𝓮𝓷𝓭 𝓓𝓮𝓿𝓮𝓵𝓸𝓹𝓮𝓻</span></p>
    <span className='text-gray-200'>i'm a Frontend Developer dedicated to creating visually appealing and user friendly digital 
    experinces.I enjoy bringing ideas to life through clean, modern designs that engage and
    inspire users.</span>
    <button className='block cursor-pointer mt-10 bg-orange-600 text-sm py-2 px-8 rounded-3xl'
