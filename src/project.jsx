...
function Project() {
  ...
  return (
    <div className="bg-black px-5 mb-20 lg:mx-8">
      {/* Header */}
      <div className="flex flex-col pb-5">
        <h2 className="text-white font-semibold text-2xl">Projects</h2>
        <span className="relative after:block after:content-[''] after:w-20 after:h-0.5 after:bg-orange-600 after:mt-1"></span>
        <span className="relative after:block after:content-[''] after:w-12 after:h-0.5 after:bg-orange-600 after:mt-1"></span>
        <span className="relative after:block after:content-[''] after:w-6 after:h-0.5 after:bg-orange-600 after:mt-1"></span>
      </div>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center gap-4 bg-black bg-opacity-50 opacity-0 hover:opacity-70 transition-opacity duration-300 rounded-lg">
                <button
                  ...
                  className="bg-white text-orange-600 font-bold px-3 py-1 rounded-lg hover:bg-orange-600 hover:text-white transition-all duration-300 ease-in-out hover:scale-105"
                >
                  Demo
                </button>
                <button
            ...
            <div className="mt-4 md:text-center">
              ...
              <div className="flex gap-2 flex-wrap md:item-center md:justify-center">
                {project.technologies.map((tech, i) => (
                  <button
                    key={i}
                    className="rounded px-3 bg-white font-semibold shadow-[2px_4px_8px_rgba(255,255,255,0.6)] text-orange-600"
                  >
                    {tech}
                  </button>
                ))}
